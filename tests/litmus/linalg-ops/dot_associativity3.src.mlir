...
func @f() -> f32 {
  ...
  %a1 = constant sparse<[[0], [1]], [1.0, 1.0]> : tensor<2xf32>
  %a2 = constant sparse<[[0], [1], [2]], [1.0, 2.0, 2.0]> : tensor<3xf32>
  %b1 = constant sparse<[[0], [1]], [1.0, 1.0]> : tensor<2xf32>
  %b2 = constant sparse<[[0], [1], [2]], [1.0, 1.0, 1.0]> : tensor<3xf32>
