...
func @f() -> tensor<f32> {
  ...
  %a0 = tensor.insert %c2 into %a[%i1] : tensor<10xf32>
  %a1 = tensor.insert %c1 into %a0[%i2] : tensor<10xf32>
  %b0 = tensor.insert %c2 into %b[%i1] : tensor<10xf32>
  %b1 = tensor.insert %c1 into %b0[%i2] : tensor<10xf32>
