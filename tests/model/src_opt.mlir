...
module  {
  ...
  func @main2(%9 : tensor<1x16xf32>) -> tensor<1xf32> {
...
// ./mlir-tv ../tests/model2/src_opt.mlir ../tests/model2/src_opt.mlir -max-const-tensor-size=1 --smt-to=10000000 --verbose -dump-smt-to=makesource 
